...
lyr_SanitaryPipesLocal_4.set('fieldLabels', {'fid': 'hidden field', 'OBJECTID': 'hidden field', 'SUBTYPE': 'no label', 'STRUCT_ID': 'hidden field', 'STRUCT_TYPE': 'inline label - always visible', 'OWNERSHIP': 'hidden field', 'INSTALL_YEAR': 'inline label - always visible', 'WIDTH': 'inline label - always visible', 'MATERIAL': 'inline label - visible with data', 'INVERT_UPSTREAM': 'hidden field', 'INVERT_DOWNSTREAM': 'hidden field', 'FUNCTION': 'hidden field', 'LIFE_CYCLE_STATUS': 'hidden field', 'Shape_Length': 'hidden field', 'LENGTHASBUILT': 'hidden field', 'Pipe_Length': 'hidden field', });
