...
lyr_StormPipesLocal_3.set('fieldLabels', {'fid': 'hidden field', 'OBJECTID': 'hidden field', 'SUBTYPE': 'hidden field', 'STRUCT_ID': 'hidden field', 'STRUCT_TYPE': 'inline label - always visible', 'OWNERSHIP': 'hidden field', 'INSTALL_YEAR': 'inline label - always visible', 'WIDTH': 'inline label - always visible', 'MATERIAL': 'inline label - visible with data', 'INVERT_UPSTREAM': 'no label', 'INVERT_DOWNSTREAM': 'no label', 'FUNCTION': 'no label', 'LIFE_CYCLE_STATUS': 'hidden field', 'Shape_Length': 'hidden field', 'LENGTHASBUILT': 'no label', 'Length_Pipe': 'hidden field', });
lyr_SanitaryPipesLocal_4.set('fieldLabels', {'fid': 'hidden field', 'OBJECTID': 'hidden field', 'SUBTYPE': 'inline label - always visible', 'STRUCT_ID': 'hidden field', 'STRUCT_TYPE': 'hidden field', 'OWNERSHIP': 'hidden field', 'INSTALL_YEAR': 'inline label - always visible', 'WIDTH': 'inline label - always visible', 'MATERIAL': 'inline label - visible with data', 'INVERT_UPSTREAM': 'no label', 'INVERT_DOWNSTREAM': 'no label', 'FUNCTION': 'no label', 'LIFE_CYCLE_STATUS': 'hidden field', 'Shape_Length': 'hidden field', 'LENGTHASBUILT': 'no label', 'Pipe_Length': 'no label', });
lyr_CombinedPipesLocal_5.set('fieldLabels', {'fid': 'hidden field', 'OBJECTID': 'hidden field', 'SUBTYPE': 'hidden field', 'STRUCT_ID': 'hidden field', 'STRUCT_TYPE': 'inline label - always visible', 'OWNERSHIP': 'hidden field', 'INSTALL_YEAR': 'inline label - always visible', 'WIDTH': 'inline label - always visible', 'MATERIAL': 'inline label - visible with data', 'INVERT_UPSTREAM': 'no label', 'INVERT_DOWNSTREAM': 'no label', 'FUNCTION': 'no label', 'LIFE_CYCLE_STATUS': 'hidden field', 'Shape_Length': 'hidden field', 'LENGTHASBUILT': 'no label', 'Pipe_Length': 'no label', });
